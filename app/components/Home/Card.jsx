...
const Card = ({ backgroundImage, hoverBackgroundImage, title, description, hoverTitle, hoverDescription, hoverPosition }) => {
    ...
    return (
        ...
        >
            <div className={`card-content ${isHovered ? 'card-hover' : ''}`}>
                ...
                {isHovered && (<div className="hover-overlay"  style={hoverPosition}>
